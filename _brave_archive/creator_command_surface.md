...
content preview portal sealed_test_portal
```

Portal preview commands are inactive scaffolding only. They must not be used to document or route current progression through the Nexus.
...
content upsert portal creator_test_portal = {"name":"Creator Test Portal","status":"sealed","resonance":"fantasy","summary":"Inactive scaffolding only.","travel_hint":"","entry_room":"brambleford_town_green"}
```
...
content upsert/write portal creator_test_portal = {"name":"Creator Test Portal","status":"sealed","resonance":"fantasy","summary":"Inactive scaffolding only.","travel_hint":"","entry_room":"brambleford_town_green"}
```
