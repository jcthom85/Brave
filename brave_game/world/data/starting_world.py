...
EXITS = [
    ...
    },
    {
        ...
        "direction": "north",
        "label": "Mastery Hall",
        "aliases": ["n", "hall", "mastery hall", "study", "gate walk", "annex", "tutorial yard", "wayfarers yard", "wayfarer's yard"],
    },
    {
        "id": "training_yard_to_mastery_hall",
        "source": "brambleford_mastery_hall",
    ...
    {
        "id": "mastery_hall_to_training_yard",
        "source": "brambleford_mastery_hall",
        "destination": "brambleford_training_yard",
        "key": "south",
        "direction": "south",
        "label": "Training Yard",
        "aliases": ["s", "yard", "training yard"],
    },
    {
