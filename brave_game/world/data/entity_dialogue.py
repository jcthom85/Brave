...
- All spoken dialogue MUST include explicit quotation marks (e.g., "\"Hello.\"").
- You can mix dialogue and prose/emotes like a book (e.g., "\"Hello,\" he says, nodding.").
- The system no longer automatically adds quotes to the start or end of lines.
"""
...
TALK_RULES = {
    "captain_harl_rowan": [
        ...
        _rule(
            "\"There you are. Before you run after trouble, settle your build and choose your class, then check your sheet and gear. Once you have your feet under you, the inn has the first honest job waiting.\"",
            active="practice_makes_heroes",
        ),
        _rule(
            "\"Ruk is the sort of brute who punishes anyone foolish enough to face him alone. Gather the family if you need to, then hit him together.\"",
            active="ruk_the_fence_cutter",
            completed="fencebreakers",
        ),
        _rule(
            "\"Town's done teaching you what it can. Head east, keep the party together, and check your map if you want the local layout before you push farther out.\"",
    ...
    "uncle_pib_underbough": [
        ...
        _rule(
            "\"Good. The cellar's fit for flour again. If you want your next bruise outdoors, Mira's waiting at the East Gate. Check your objectives if you want the road written plain before you go.\"",
            active="roadside_howls",
        ),
        _rule(
        ...
        _rule(
            "\"First days are for getting your bearings. If the town feels wide, check your objectives. If the road feels wider, come back here and rest. If you want something calmer, the wharf south of the green is open and the hearth here will take anything decent you catch.\"",
            xp_eq=0,
        ),
        _rule(
    ...
    "mira_fenleaf": [
        ...
        _rule(
            "\"Ruk's camp is just beyond Wolf Turn. Bring your party, keep pressure on him when he starts bellowing for help, and don't ignore the bleeding cuts from that axe.\"",
            active="ruk_the_fence_cutter",
            completed="fencebreakers",
        ),
        _rule(
        ...
        _rule(
            "\"Start at the gate, then push to the Old Fence Line and Wolf Turn. If you want to gauge the road before committing, size up your enemies and then fight when you're ready.\"",
            active="roadside_howls",
        ),
        _rule(
    ...
    "sister_maybelle": [
        ...
        _rule(
            "\"Brother Alden has taken over the chapel watch for now. If the mayor has you walking west, listen to the bell before you cross the barrows. It is never good when iron sounds tired. If you want the chapel at your back first, pray there before you go.\"",
            active_any=("lanterns_at_dusk", "do_not_disturb_the_dead"),
        ),
        _rule(
    ...
    "joss_veller": [
        ...
        _rule(
            "\"Every gate needs an anchor or you stop calling it travel and start calling it loss. The ring below is holding one stable bridge for now. Review the lineup, then step through when you're ready to test your nerve somewhere stranger.\"",
            room_id="brambleford_nexus_gate",
        ),
        _rule(
            "\"Different sky, same bones. The world here skins your instincts as tech. Your sheet will show the local names, and the return gate will always answer while I keep the bridge lit.\"",
            resonance="tech",
        ),
        _rule(
    ...
    "brother_alden": [
        _rule(
            "\"Sir Edric lies at the Sunken Dais, but not quietly enough. When grave-lights answer him, cut those lesser spirits down first. The ward around him should fail once the dead he leans on are gone. Ring the Dawn Bell and pray before you cross if you want steadier hands.\"",
            active="the_knight_without_rest",
        ),
        _rule(
        ...
        _rule(
            "\"The Dawn Bell has started answering with a thin, wrong note at dusk. Cross the causeway and see whether the field itself is stirring. If the air turns cold and the crows stop making natural noises, trust that instinct. And if you mean to go, pray before you leave the chapel.\"",
            active="lanterns_at_dusk",
        ),
        _rule(
        ...
        _rule(
            "\"The chapel keeps records, candles, and the sort of silence people only notice when they lose it. If you need the Dawn Bell at your back before a hard road, ring your courage true and pray here before you leave.\""
        ),
    ],
}
...
STATIC_READ_RESPONSES = {
    ...
    "dawn_bell": (
        ...
        "LET MEMORY REST, LET THE LOST HEAR THE WAY HOME. Those who kneel beneath it before a hard road still say the chapel answers. Pray if you mean to test that."
    ),
    ...
    "forge_order_board": (
        ...
        "ASK AT THE FORGE, NOT WITH STORIES."
    ),
