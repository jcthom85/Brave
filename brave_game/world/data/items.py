...
ITEM_TEMPLATES = {
    ...
    "fenlight_talisman_pattern": {
        "name": "Fenlight Talisman Pattern",
        "kind": "consumable",
        "stackable": True,
        "summary": "A careful bench pattern on seating drowned glass in a ward-iron frame without letting the wrong light keep an opinion about it.",
        "use": {
            "verb": "study",
            "contexts": ("explore",),
            "target": "self",
            "effect_type": "unlock_recipe",
            "recipe_domain": "tinkering",
            "unlock_recipe": "fenlight_talisman_setting",
        },
    },
    "fenlight_talisman": {
    ...
    "stitchleaf_salve": {
        "name": "Stitchleaf Salve",
        "kind": "consumable",
        "stackable": True,
        "summary": "A thick resin salve with hedge mushroom and bitter herbs worked in until it smells like a treatment plan rather than a meal.",
        "use": {
            "verb": "apply",
            "contexts": ("explore", "combat"),
            "target": "ally",
            "effect_type": "restore",
            "restore": {"hp": 24, "stamina": 8},
        },
    },
    "crowfeather_rite": {
    ...
    "dawnscale_supper_note": {
        "name": "Dawnscale Supper Note",
        "kind": "consumable",
        "stackable": True,
        "summary": "An inn note stained with butter and lantern soot, detailing how to handle rare trout without ruining the flesh or your pride.",
        "use": {
            "verb": "study",
            "contexts": ("explore",),
            "target": "self",
            "effect_type": "unlock_recipe",
            "recipe_domain": "cooking",
            "unlock_recipe": "dawnscale_supper",
        },
    },
    ...
    "marsh_root": {
        ...
        "kind": "ingredient",
        "stackable": True,
        "summary": "A pale knuckled root pulled from wet ground, bitter raw and far more useful once cooked down.",
        "value": 5,
    },
    "silver_eel": {
        "name": "Silver Eel",
    ...
    "hedge_mushroom": {
        ...
        "kind": "ingredient",
        "stackable": True,
        "summary": "A firm brown cap from shaded roots and damp hedgerows, good in a pan if you know what you're doing.",
        "value": 5,
    },
    "crisped_perch_plate": {
    ...
    "dawnscale_supper": {
        "name": "Dawnscale Supper",
        "kind": "meal",
        "stackable": True,
        "summary": "Rare trout seared hard at the skin and finished with bright herb butter.",
        "restore": {"hp": 16, "mana": 10, "stamina": 20},
        "meal_bonuses": {"accuracy": 3, "precision": 2, "max_stamina": 8},
    },
    "hedgeroot_hash": {
        "name": "Hedgeroot Hash",
        "kind": "meal",
        "stackable": True,
        "summary": "A hot pan hash of chopped marsh root, hedge mushroom, and enough browned fat to count as frontier optimism.",
        "restore": {"hp": 18, "stamina": 16},
        "meal_bonuses": {"max_hp": 10, "max_stamina": 8},
    },
    "riverlight_chowder": {
    ...
    "moonleaf_eel_skillet": {
        "name": "Moonleaf Eel Skillet",
        "kind": "meal",
        "stackable": True,
        "summary": "Silver eel fried in a black pan with moonleaf, pepper, and enough butter to make the smell carry.",
        "restore": {"hp": 18, "mana": 18, "stamina": 10},
        "meal_bonuses": {"spell_power": 3, "max_mana": 12, "spirit": 1},
    },
    "moonleaf_root_broth": {
        "name": "Moonleaf Root Broth",
        "kind": "meal",
        "stackable": True,
        "summary": "A clear root broth with moonleaf and pepper that warms the gut and quiets the hands.",
        "restore": {"hp": 16, "mana": 14, "stamina": 10},
        "meal_bonuses": {"max_hp": 4, "max_mana": 10, "spirit": 1},
    },
    "wharfside_skewers": {
    ...
    "lockfin_pike": {
        ...
        "kind": "ingredient",
        "stackable": True,
        "summary": "A hard-jawed pike from drowned lock water, all scarred scales and bad attitude.",
        "value": 10,
    },
    "lockfin_skillet_note": {
        "name": "Lockfin Skillet Note",
        "kind": "consumable",
        "stackable": True,
        "summary": "A damp kitchen scrap on searing lockfin hard, resting the flesh, and not letting marsh root bully the pan.",
        "use": {
            "verb": "study",
            "contexts": ("explore",),
            "target": "self",
            "effect_type": "unlock_recipe",
            "recipe_domain": "cooking",
            "unlock_recipe": "lockfin_skillet",
        },
    },
    "lockfin_skillet": {
        "name": "Lockfin Skillet",
        "kind": "meal",
        "stackable": True,
        "summary": "A blackened pike skillet with marsh root and pepper, dense enough to make cold weather reconsider.",
        "restore": {"hp": 20, "stamina": 14},
        "meal_bonuses": {"armor": 2, "attack_power": 2, "max_hp": 8},
    },
    "field_bandage": {
        "name": "Field Bandage",
        "kind": "consumable",
    ...
    "grease_stained_supper_note": {
        "name": "Grease-Stained Supper Note",
        "kind": "consumable",
        "stackable": True,
        "summary": "A cook's folded note about getting eel and moonleaf to work together instead of arguing in the pan.",
        "use": {
            "verb": "study",
            "contexts": ("explore",),
            "target": "self",
            "effect_type": "unlock_recipe",
            "recipe_domain": "cooking",
            "unlock_recipe": "moonleaf_eel_skillet",
        },
    },
    "latchwire_ward_pattern": {
        "name": "Latchwire Ward Pattern",
        "kind": "consumable",
        "stackable": True,
        "summary": "A grubby note bundle in Veska's hand explaining how to lash scavenged nails into a ward that holds just long enough to matter.",
        "use": {
            "verb": "study",
            "contexts": ("explore",),
            "target": "self",
            "effect_type": "unlock_recipe",
            "recipe_domain": "tinkering",
            "unlock_recipe": "latchwire_ward_bundle",
        },
    },
    "fireflask": {
        "name": "Fire Flask",
    ...
    "latchwire_ward": {
        ...
        "kind": "consumable",
        "stackable": True,
        "summary": "A wrapped knot of bent nails, cord, and road-ward chalk meant to catch the first ugly hit on stubborn terms.",
        "use": {
            "verb": "cast",
            "contexts": ("combat",),
            "target": "ally",
    ...
    "purity_salts_formula": {
        "name": "Purity Salts Formula",
        "kind": "consumable",
        "stackable": True,
        "summary": "A sharp little formula sheet on ash salts, herb ratios, and how not to poison the patient while trying to save them.",
        "use": {
            "verb": "study",
            "contexts": ("explore",),
            "target": "self",
            "effect_type": "unlock_recipe",
            "recipe_domain": "tinkering",
            "unlock_recipe": "purity_salts_satchel",
        },
    },
    "veskas_pitchfire_pattern": {
        "name": "Veska's Pitchfire Pattern",
        "kind": "consumable",
        "stackable": True,
        "summary": "A workbench pattern in Veska's hand explaining how to bottle resin, spite, and bad intentions into something you should only throw away from yourself.",
        "use": {
            "verb": "study",
            "contexts": ("explore",),
            "target": "self",
    ...
    "weirglass_eel": {
        ...
        "kind": "ingredient",
        "stackable": True,
        "summary": "A pale eel from the drowned line whose skin catches bad light like cracked glass.",
        "value": 12,
    },
    "hollow_glass_shard": {
