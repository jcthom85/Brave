...
HELP_ENTRY_DICTS = [
    ...
    },
    {
        ...
        "text": """
            ...
            - Explore Brambleford, the current fantasy ladder through Drowned Weir, and the first guest-world bridge
            ...
            - The old gate listing has been retired from this slice
            ...
            The old gate listing is no longer part of the current loop.
