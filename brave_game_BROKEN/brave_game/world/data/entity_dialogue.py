...
TALK_RULES = {
    "captain_harl_rowan": [
        ...
        _rule(
            "Ruk is the sort of brute who punishes anyone foolish enough to face him alone. Use `party invite <name>` if you need to gather the family, and when he drags that axe back for a big swing, interrupt him or throw up a guard before it lands.",
    ...
    "mira_fenleaf": [
        ...
        _rule(
            "Ruk's camp is just beyond Wolf Turn. Bring a `party`, keep pressure on him when he starts bellowing for help, and when he hauls the axe back for a fence-cleaver swing, spoil it fast or cover whoever he's lining up.",
            active="ruk_the_fence_cutter",
            completed="fencebreakers",
        ),
        _rule(
    ...
    "joss_veller": [
        ...
        _rule(
            "Every gate needs an anchor or you stop calling it travel and start calling it loss. The ring below is holding one stable bridge for now, but the old gate listing is being retired. Keep `east` in mind when you're ready to test your nerve somewhere stranger.",
        ...
        _rule(
            "Most folk think I light lamps. True enough. They just forget a gate is another sort of lamp if you know what to feed it. The observatory's the town's bridge center, whether the mayor likes the phrase or not."
        ),
    ],
    "mayor_elric_thorne": [
        _rule(
