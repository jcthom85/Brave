...
QUESTS = {
    "practice_makes_heroes": {
        ...
        "completion_reaction": "Captain Harl turns you loose into Brambleford proper. The guided part is over now.",
    ...
    "rats_in_the_kettle": {
        ...
        "completion_reaction": "The cellar is fit for flour again, and the inn starts treating you like a real problem-solver instead of a fresh arrival.",
    ...
    "roadside_howls": {
        ...
        "objectives": [
            ...
            },
            {
                ...
                "description": "Reach the Old Fence Line on Goblin Road.",
            },
            {
                "type": "visit_room",
                "room_id": "goblin_road_wolf_turn",
                "description": "Push as far as Wolf Turn and see how dangerous the road has become.",
            },
        ],
        ...
        "objectives": [
            {
                ...
                "enemy_tag": "goblin",
                "count": 2,
                "description": "Defeat 2 goblin raiders on Goblin Road.",
            }
        ],
    ...
    "ruk_the_fence_cutter": {
        ...
        "objectives": [
            ...
            },
            {
                "type": "defeat_enemy",
                "enemy_tag": "ruk",
                "description": "Defeat Ruk the Fence-Cutter.",
            },
        ],
    ...
    "bridgework_for_joss": {
        ...
        "branch_choice": True,
        "next_step": "Speak with Joss Veller at the observatory, then take the stable gate east to Junk-Yard Landing.",
        "objectives": [
            {
                "type": "visit_room",
    ...
    "what_whispers_in_the_wood": {
        ...
        "rewards": {
            "xp": 100,
            "silver": 8,
            "items": [{"item": "briar_heart", "quantity": 1}],
        },
    },
    "herbs_for_sister_maybelle": {
        ...
        "rewards": {
            "xp": 110,
            "silver": 8,
            "items": [{"item": "moonleaf_sprig", "quantity": 2}],
        },
    },
    "greymaws_trail": {
        ...
        "rewards": {
            "xp": 140,
            "silver": 12,
            "items": [{"item": "greymaw_pelt", "quantity": 1}],
        },
    },
    "lanterns_at_dusk": {
    ...
    "bogwater_rumors": {
        ...
        "rewards": {
            "xp": 320,
            "silver": 30,
            "items": [{"item": "mire_hound_hide", "quantity": 1}],
        },
    },
    "lights_in_the_reeds": {
        ...
        "rewards": {
            "xp": 350,
            "silver": 36,
            "items": [{"item": "rotcrow_pinion", "quantity": 2}],
        },
    },
    "miretooths_claim": {
    ...
    "the_south_light": {
        ...
        "rewards": {
            "xp": 360,
            "silver": 34,
            "items": [{"item": "hollow_glass_shard", "quantity": 1}],
        },
    },
    "locks_under_blackwater": {
        ...
        "rewards": {
            "xp": 390,
            "silver": 40,
            "items": [{"item": "ward_iron_rivet", "quantity": 2}],
        },
    },
    "the_hollow_lantern": {
