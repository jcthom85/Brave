...
content upsert forge militia_blade = {"result":"ironroot_longblade","silver":18,"materials":{"wolf_fang":1},"text":"..."}
```
...
content upsert/write forge militia_blade = {"result":"ironroot_longblade","silver":18,"materials":{"wolf_fang":1},"text":"..."}
```
