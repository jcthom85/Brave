...
Welcome to the documentation for **Brave**, a family-focused fantasy MUD (Multi-User Dungeon) built for cooperative play, creative storytelling, and world-building.

## Project Vision

`Brave` is designed as a digital hangout for a family of four. It focuses on a cozy, "early-MMO" fantasy core built around Brambleford, a compact chapter-based world, and town-side activities the family can return to together.

### Core Pillars
- **Family First:** A safe, warm, and cooperative experience.
- **Small, Finished Fantasy Core:** A focused campaign that feels complete before the game expands outward.
...
- [**World and Content**](world_and_content.md): Detailed descriptions of Brambleford, its NPCs, and the phase-1 fantasy ladder.
...
Phase 1 establishes the "Home Base" and a complete first fantasy chapter:
...
- **Hub:** Brambleford, Outfitters, Ironroot Forge, Trophy Hall, Observatory, and the old gate platform.
